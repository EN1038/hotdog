  ...
  return (
    <div className="space-y-2">
      <p className="text-xs leading-relaxed text-gray-600">
        {hasMapPin(value)
          ? "ใช้หมุดที่บันทึกไว้ หรือลาก/กด “ตำแหน่งปัจจุบัน” เพื่อเปลี่ยน — ที่อยู่จากแผนที่จะถูกเติมให้อัตโนมัติถ้าช่องรายละเอียดยังว่าง"
          : "ระบบจะขอตำแหน่งปัจจุบันครั้งแรก แล้วเติมที่อยู่จากแผนที่ให้ — หรือกด “ตำแหน่งปัจจุบัน” / ลากหมุดเอง"}{" "}
