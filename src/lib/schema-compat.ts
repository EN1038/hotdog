  ...
  if (!ensurePromise) {
    ensurePromise = (async () => {
      ...
      const statements = [
        ...
        `ALTER TABLE "${schema}"."Order" ADD COLUMN IF NOT EXISTS "discountReason" TEXT`,
        `ALTER TABLE "${schema}"."Order" ADD COLUMN IF NOT EXISTS "discountReasonNote" TEXT`,
        ...
        `ALTER TABLE "${schema}"."SkewerOrder" ADD COLUMN IF NOT EXISTS "discountAmount" DECIMAL(10,2) NOT NULL DEFAULT 0`,
        `ALTER TABLE "${schema}"."SkewerOrder" ADD COLUMN IF NOT EXISTS "discountReason" TEXT`,
        `ALTER TABLE "${schema}"."SkewerOrder" ADD COLUMN IF NOT EXISTS "discountReasonNote" TEXT`,
        ...
        `CREATE TABLE IF NOT EXISTS "${schema}"."BranchTomorrowPlan" ("id" TEXT NOT NULL, "branchId" TEXT NOT NULL, "planDate" TEXT NOT NULL, "roundNo" INTEGER NOT NULL DEFAULT 1, "status" TEXT NOT NULL DEFAULT 'CONFIRMED', "note" TEXT, "confirmedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "confirmedByAdminId" TEXT, CONSTRAINT "BranchTomorrowPlan_pkey" PRIMARY KEY ("id"))`,
        `ALTER TABLE "${schema}"."BranchTomorrowPlan" ADD COLUMN IF NOT EXISTS "roundNo" INTEGER NOT NULL DEFAULT 1`,
        `UPDATE "${schema}"."BranchTomorrowPlan" SET "roundNo" = 1 WHERE "roundNo" IS NULL OR "roundNo" < 1`,
        `DROP INDEX IF EXISTS "${schema}"."BranchTomorrowPlan_branchId_planDate_key"`,
        `DROP INDEX IF EXISTS "BranchTomorrowPlan_branchId_planDate_key"`,
        `CREATE UNIQUE INDEX IF NOT EXISTS "BranchTomorrowPlan_branchId_planDate_roundNo_key" ON "${schema}"."BranchTomorrowPlan"("branchId", "planDate", "roundNo")`,
        `CREATE INDEX IF NOT EXISTS "BranchTomorrowPlan_branchId_planDate_idx" ON "${schema}"."BranchTomorrowPlan"("branchId", "planDate")`,
        ...
        `DROP INDEX IF EXISTS "${schema}"."BranchTomorrowPlanLine_branchId_menuItemId_planDate_key"`,
        `DROP INDEX IF EXISTS "BranchTomorrowPlanLine_branchId_menuItemId_planDate_key"`,
        `CREATE UNIQUE INDEX IF NOT EXISTS "BranchTomorrowPlanLine_planId_menuItemId_key" ON "${schema}"."BranchTomorrowPlanLine"("planId", "menuItemId")`,
        `ALTER TABLE "${schema}"."Brand" ADD COLUMN IF NOT EXISTS "smsQuotaGranted" INTEGER NOT NULL DEFAULT 0`,
        `ALTER TABLE "${schema}"."Brand" ADD COLUMN IF NOT EXISTS "lineNotifyNewOrder" BOOLEAN NOT NULL DEFAULT false`,
        `ALTER TABLE "${schema}"."Brand" ADD COLUMN IF NOT EXISTS "lineNotifySkewerOrder" BOOLEAN NOT NULL DEFAULT false`,
        `ALTER TABLE "${schema}"."Brand" ADD COLUMN IF NOT EXISTS "lineNotifyDailySummary" BOOLEAN NOT NULL DEFAULT false`,
