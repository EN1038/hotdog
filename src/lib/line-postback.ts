...
export const LINE_LOGIN_INSTRUCTIONS = [
  "เชื่อมสิทธิ์แก้ไข-ลบออเดอร์",
  "",
  "แอดมินแพลตฟอร์มเท่านั้น:",
  "1) เปิด /admin/line-connect",
  "2) กดสร้างรหัส 6 หลัก",
  "3) พิมพ์รหัส 6 หลักในแชทนี้ภายใน 10 นาที",
].join("\n");

export const LINE_ADMIN_HELP_TEXT = [
  "เมนูหลังบ้าน LINE (SkillSale POS)",
  "• เปิด/ปิดแจ้งเตือน — รับเมื่อมีคนสมัคร Owner ใหม่",
